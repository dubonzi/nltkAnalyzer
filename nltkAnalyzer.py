...
class TextRequirementProcessor(object):
    ...
    def assign_temp_files_content(self, wordtype_categories, lemmatized_list_by_verb_noun_adj_adv):
    ...
    def plot_results(self, lemmatized_list_by_verb_noun_adj_adv, number_of_cat):
